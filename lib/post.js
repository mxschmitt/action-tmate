...
function getTmateExecutablePath() {
  ...
  } else if (lib_core.getInput("install-dependencies") !== "false" && process.platform !== "darwin") {
...
async function waitUntilDebuggingSessionExit() {
  ...
  while (true) {
    ...
    if (lib_core.getInput("check-num-clients") !== "false" && !(await doesTmateHaveConnectedClients())) {
